...
?>
    ...
    <div class="container " id="content">
        <h3 class="text-center" style=" margin:5% 0%; margin-top:2%;font-weight:700;font-size:30px">Welcome To
            <!--𝕠 -->Discussion Forum
        </h3>
...
// <!-- use while loop to iterate department -->
        $id = $row['Dept_id'];
        $dept = $row['Dept_name'];
        $desc = $row['Dept_description'];
        $img = $row['Dept_img'];
          echo '
          <div class="col-md-4 my-4" style="max-width:50.33333%" >
